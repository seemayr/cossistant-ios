...
When asked to do a code review, load and follow the rules in [`docs/CODE_REVIEW.md`](docs/CODE_REVIEW.md).

## Localization

Full localization guide: [`docs/LOCALIZATION_SYSTEM.md`](docs/LOCALIZATION_SYSTEM.md)
